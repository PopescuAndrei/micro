...
public interface ScoreCardRepository extends CrudRepository<ScoreCard, Long> {
     ...
     */
    @Query("SELECT SUM(s.score) FROM micro.book.gamification.domain.ScoreCard s WHERE s.userId = :userId GROUP BY s.userId")
     ...
     */
    @Query("SELECT NEW micro.book.gamification.domain.support.LeaderBoardRow(s.userId, SUM(s.score)) " +
            "FROM micro.book.gamification.domain.ScoreCard s " +
